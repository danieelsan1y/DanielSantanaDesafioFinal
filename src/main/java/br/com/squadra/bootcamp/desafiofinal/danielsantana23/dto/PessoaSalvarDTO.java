...
public class PessoaSalvarDTO implements Serializable {
    ...
    public PessoaSalvarDTO(String nome, String sobrenome, String login, String senha, Integer status, List<EnderecoDTO> enderecos ) {
        this.nome = nome;
